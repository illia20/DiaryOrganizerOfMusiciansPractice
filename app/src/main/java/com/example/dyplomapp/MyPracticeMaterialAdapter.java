...
public class MyPracticeMaterialAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{

    final int textModeVar = 0, mediaModeVar = 1, pdfModeVar = 2, ytModeVar = 3;
    final RecyclerViewInterface recyclerViewInterface;

    List<PracticeMaterial> listItems;
    Context context;
    public ExoPlayer player;
    Lifecycle lifecycle;

    public MyPracticeMaterialAdapter(List<PracticeMaterial> listItems, Context context, Lifecycle lifecycle, RecyclerViewInterface recyclerViewInterface) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if(viewType == textModeVar){
            ...
            viewHolder = new PDFViewHolder(modelView);
        }
        ...
        if(holder.getItemViewType() == textModeVar){
            ...
            pdfViewHolder.button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra(PracticeMaterial.class.getSimpleName(), practiceMaterial);
